      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            HorizontalImageList(images: images), // تعديل لتمرير الصور أفقيًا
          ],
        ),
      ),
    );
...
class ImageCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AspectRatio(
      aspectRatio: 3 / 2, // نسبة العرض إلى الارتفاع
      child: Container(
